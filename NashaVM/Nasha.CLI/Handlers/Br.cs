...
namespace Nasha.CLI.Handlers
{
    ...
    {
        public NashaOpcode Handler => NashaOpcode.Br;
        ...
        {
            return new NashaInstruction(NashaOpcode.Br, OffsetHelper.Get(method.Body.Instructions.IndexOf((Instruction)method.Body.Instructions[index].Operand)));
        }

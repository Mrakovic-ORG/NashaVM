...
namespace Nasha.CLI.Handlers
{
    ...
    {
        public NashaOpcode Handler => NashaOpcode.Ldloc;
        ...
        {
            return new NashaInstruction(NashaOpcode.Ldloc, method.Body.Variables.IndexOf(method.Body.Instructions[index].GetLocal(method.Body.Variables)));
        }
